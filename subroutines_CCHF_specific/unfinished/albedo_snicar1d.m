% Adapted by Thomas Mosier (mosier.thomas@gmail.com) from original 
%'SNICAR8d.m' function written by Mark Flanner.
...
function data_out = albedo_snicar1d(BND_TYP_IN, DIRECT_IN, APRX_TYP_IN, ...
