...
if isempty(varargin(:))
    ...
    varargout{1} = cat(1,varargout{1}, {'gen_melt_pwr', -2, 2, 0, 'mass_enbal','cryo'});  %Units of mm/hr/Deg C
%     varargout{1} = cat(1,varargout{1}, {'tsn_pwr', -2,   2,    0, 'melt_enbal','cryo'});
    
    if isfield(sCryo,'icdbr')
        varargout{1} = cat(1,varargout{1}, {'debris_scalar', 0, 2, 1, 'mass_enbal','cryo'});  %Unitless
    end
